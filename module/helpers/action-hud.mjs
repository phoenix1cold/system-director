...
function wireHudWidget(cell, widgetDef, actor) {
  ...
  // Animation Tag (Automated Animations) delegation. Mirrors the wiring on
  // character / item sheets so widgets in the Action HUD also fire AA when
  // the user clicks an actionable child of a `.widget[data-aa-tag]` element.
  // Excluded data-action values: builder / config controls (wcfg / wdup /
  // wspan / wdel) and "edit / delete" item-management controls, where firing
  // an animation would be unexpected.
